...
import { fetchProjects, createProject, fetchProject, addProjectMember, removeProjectMember , deleteProject  } from '../api/projects';
...
export const useDeleteProject = (orgId) => {
  const queryClient = useQueryClient();
  return useMutation({
